...
class SSD(nn.Module):
    ...
    def __init__(self, phase,width,height, base, extras, head, num_classes):
...
def build_ssd(phase,width,height, num_classes=21):
    ...
    return SSD(phase,width,height, base_, extras_, head_, num_classes)
